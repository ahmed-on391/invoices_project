				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Unpaid') }}">الفواتير الغير المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Partial') }}">الفواتيرالمدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='Archive') }}"> الارشيف  </a></li>
