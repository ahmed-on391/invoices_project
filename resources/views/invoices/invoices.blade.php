...
@section('content')
    ...
    @endif
						...
						<div class="row"><!-- أكتب هنا اللي انت عايزه بالعربي بالانجليزي في الخاصية ده -->
														...
														<div class="dropdown">
															...
															<div  class="dropdown-menu tx-13">
																...
																<a class="dropdown-item" href="{{URL::route('Status_show', [$invoice->id])}}"> 
																	<i class="text-success fa fa-money-bill"></i>&nbsp;&nbsp;تغيير حالة الدفع
																</a>
															...
															<a class="dropdown-item" href="print_invoice/{{ $invoice->id }}"> 
																	<i class="text-success fa fa-print"></i>&nbsp;&nbsp;طباعة الفاتورة
																</a>
															</div>
														</div>
...
<!-- ده بتاع شكل الفاتورة يعني بينظمها	 -->
