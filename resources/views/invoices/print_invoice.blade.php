                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>شركة أحمد لتحصيل الفواتير</h6>
                                <p>شارع ما، مدينة ما، دولة 12345<br>
       الهاتف: 01159081499<br>
        البريد الإلكتروني: ahmededress111@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">مرسل إلى:</label>
                                <div class="billed-to">
                                    <h6>شركة لارفل لتحصيل الفواتير</h6>
                                    <p>شارع السلام، مدينة القاهرة، مصر<br>
                الهاتف: 012 345 6789<br>
                البريد الإلكتروني: mohamed@example.com</p>
                                </div>
                            </div>
                            <div class="col-md">
