...
@section('content')
				<!-- row -->
				<div class="row">
					<!-- اكتب اللي انت عايزه هنا كجدول مثلا -->
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<!-- <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button class="btn btn-outline-secondary btn-rounded btn-block">&nbsp; اضافة منتج</button></div> -->

								<div class="d-flex justify-content-between">
									<button type="button" class="btn btn-secondary btn-rounded btn-block" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i>&nbsp; اضافة منتج</button>
								</div>
